...
export function Layout() {
  ...
  return (
    <div className="antialiased text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 w-full z-50 px-8 sm:px-12 md:px-16 pt-8 md:pt-10 pb-6 md:pb-8 flex justify-between items-center bg-transparent transition-all duration-500 nav-animate">
